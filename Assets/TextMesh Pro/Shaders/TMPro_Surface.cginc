...
void PixShader(Input input, inout SurfaceOutput o) {
  ...
  faceColor *= tex2D(
    _FaceTex,
    float2(input.uv2_FaceTex.x + _FaceUVSpeedX * _Time.y, input.uv2_FaceTex.y + _FaceUVSpeedY * _Time.y)
  );
  outlineColor *= tex2D(
    _OutlineTex,
    float2(input.uv2_OutlineTex.x + _OutlineUVSpeedX * _Time.y, input.uv2_OutlineTex.y + _OutlineUVSpeedY * _Time.y)
  );
  ...
  float3 emission = reflcol.rgb * lerp(
    _ReflectFaceColor.rgb,
